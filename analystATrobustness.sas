...
data allmiss;
 set thirdre4 fourthre4 sixthre4 ninthre4 fifteenthre4;
run;
...
data allobscomp;
 set firstmergeryears secondmergeryears thirdmergeryears fourthmergeryears sixthmergeryears ninthmergeryears fifteenthmergeryears;
run;
...
*Export to STATA;
proc export data=temp.cscorerobust outfile= "D:\ay32\My Documents\Fall 2013\cscorerobust.dta" replace;
run;

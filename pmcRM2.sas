...
proc sql;*http://sbaleone.bus.miami.edu/PERLCOURSE/SASFILES/SQL_EXAMPLES.sas;
 ...
 as select a.*, b.postreduction, b.cut, b.postincrease, b.raise
...
data tradeprod2;
 ...
 benchzeropostred=benchzero*postreduction;
 benchlastpostred=benchlast*postreduction;
 benchpostinc=bench*postincrease;
run;
...
proc export data=temp.fresard outfile= "D:\ay32\My Documents\Fall 2013\fresard.dta" replace;
run;
